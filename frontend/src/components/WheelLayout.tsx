...
export const WheelLayout: React.FC<WheelLayoutProps> = ({ positions, selectedId, onSelect }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="overflow-x-auto pb-2">
        <div className="mx-auto min-w-fit px-2">
          <div className="flex items-stretch justify-center gap-5 sm:gap-6">
            <div className="flex flex-col items-end gap-2.5 sm:gap-3.5">
              {axleLayout.map((row, index) => (
                <div key={`left-${index}`} className="flex justify-end gap-2.5 sm:gap-3.5">
            ...
            <div className="flex flex-col items-start gap-2.5 sm:gap-3.5">
              {axleLayout.map((row, index) => (
                <div key={`right-${index}`} className="flex justify-start gap-2.5 sm:gap-3.5">
      ...
      <div className="flex items-center justify-center gap-3 sm:gap-4 px-6 sm:px-10">
